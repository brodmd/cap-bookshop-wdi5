const { uploadWdi5ResultsToOctane } = require("../../../../../cicd_scripts/UploadTestResults")

const testReportFolder = "./test_reports";
exports.config = {
	// ====================
	// wdi5 Configuration
	// ====================
	...
	reporters: [
		...
		[
			"html-nice",
			{
				outputDir: testReportFolder + "/html/",
		...
		[
			"junit",
			{
				outputDir: testReportFolder + "/junit/",
